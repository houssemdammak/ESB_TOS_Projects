...
package web_services_projects.helloworldservice_0_1;
...
/**
 * Job: HelloWorldService Purpose: <br>
 * Description:  <br>
 * @author user@talend.com
 * @version 8.0.1.20211109_1610
 * @status 
 */
public class HelloWorldService implements TalendJob {
...
protected static void logIgnoredError(String message, Throwable cause) {
	...
	private final String jobName = "HelloWorldService";
	private final String projectName = "WEB_SERVICES_PROJECTS";
	...
	public void printStackTrace() {
		...
		if (!(e instanceof TDieException)) {
			if(e instanceof TalendException){
				...
				HelloWorldService.this.exception = e;
			}
		}
		if (!(e instanceof TalendException)) {
		try {
			for (java.lang.reflect.Method m : this.getClass().getEnclosingClass().getMethods()) {
				if (m.getName().compareTo(currentComponent + "_error") == 0) {
					m.invoke(HelloWorldService.this, new Object[] { e , currentComponent, globalMap});
					break;
				}
			}
...
public static class RestServiceProviderImpl4TalendJob {
	...
	private final HelloWorldService job;

	public RestServiceProviderImpl4TalendJob(HelloWorldService job) {
		this.job = job;
	}

	private void populateRequestWithJobContext(java.util.Map<String, Object> requestGlobalMap, HelloWorldService job) {
	...
	@javax.ws.rs.Path("/{name}")	@javax.ws.rs.Produces({ "application/xml", "text/xml", "application/json" })
	public javax.ws.rs.core.Response hello(
		...
		request_tRESTRequest_1.put("OPERATION", "hello");
		request_tRESTRequest_1.put("PATTERN", "/{name}");
		...
		java.util.Map<String, Object> parameters_tRESTRequest_1 = new java.util.HashMap<String, Object>();
			...
			parameters_tRESTRequest_1.put("PATH:name:id_String", name);
...
class Thread4RestServiceProviderEndpoint extends Thread {
	...
	public Thread4RestServiceProviderEndpoint(HelloWorldService job, String endpointUrl) {
		this.job = job;
	...
	public static class ContextBean {
		static String evaluate(String context, String contextExpression)
			...
			java.io.InputStream inContext = HelloWorldService.class.getClassLoader()
					.getResourceAsStream("web_services_projects/helloworldservice_0_1/contexts/" + context + ".properties");
			if (inContext == null) {
				inContext = HelloWorldService.class.getClassLoader()
...
public static class outStruct implements routines.system.IPersistableRow<outStruct> {
    final static byte[] commonByteArrayLock_WEB_SERVICES_PROJECTS_HelloWorldService = new byte[0];
    static byte[] commonByteArray_WEB_SERVICES_PROJECTS_HelloWorldService = new byte[0];
    ...
    public void readData(ObjectInputStream dis) {
		...
		synchronized(commonByteArrayLock_WEB_SERVICES_PROJECTS_HelloWorldService) {
...
public static class helloStruct implements routines.system.IPersistableRow<helloStruct> {
    final static byte[] commonByteArrayLock_WEB_SERVICES_PROJECTS_HelloWorldService = new byte[0];
    static byte[] commonByteArray_WEB_SERVICES_PROJECTS_HelloWorldService = new byte[0];
	...
	private String readString(ObjectInputStream dis) throws IOException{
		...
		if (length == -1) {
			...
			if(length > commonByteArray_WEB_SERVICES_PROJECTS_HelloWorldService.length) {
				if(length < 1024 && commonByteArray_WEB_SERVICES_PROJECTS_HelloWorldService.length == 0) {
   					commonByteArray_WEB_SERVICES_PROJECTS_HelloWorldService = new byte[1024];
				} else {
   					commonByteArray_WEB_SERVICES_PROJECTS_HelloWorldService = new byte[2 * length];
   				}
			}
			dis.readFully(commonByteArray_WEB_SERVICES_PROJECTS_HelloWorldService, 0, length);
			strReturn = new String(commonByteArray_WEB_SERVICES_PROJECTS_HelloWorldService, 0, length, utf8Charset);
		}
		return strReturn;
	}
	...
	private String readString(org.jboss.marshalling.Unmarshaller unmarshaller) throws IOException{
		...
		if (length == -1) {
			...
			unmarshaller.readFully(commonByteArray_WEB_SERVICES_PROJECTS_HelloWorldService, 0, length);
			strReturn = new String(commonByteArray_WEB_SERVICES_PROJECTS_HelloWorldService, 0, length, utf8Charset);
		}
		return strReturn;
	}
...
public void tRESTRequest_1_LoopProcess(final java.util.Map<String, Object> globalMap) throws TalendException {
 ...
 final boolean execStat = this.execStat;
	...
	try {
		...
		helloStruct hello = new helloStruct();
outStruct out = new outStruct();
	...
	currentComponent="tRESTRequest_1_Loop";
		...
		int tos_count_tRESTRequest_1_Loop = 0;
						...
						if(execStat){
							runStat.updateStatOnConnection(iterateId,0,0,"hello","out");
						}
 ...
 */
	...
	currentComponent="tXMLMap_1";
					...
					if(execStat) {
						runStat.updateStatOnConnection(resourceMap,iterateId,0,0,"hello");
					}
...
//    	this.treeNodeAPI = treeNodeAPI;
    ...
    void generateElements(boolean isInnerJoin, helloStruct hello, Var__tXMLMap_1__Struct Var
	) {
...
if (needRoot) {
	needRoot=false;
		...
		valueMap.put("root_0","Hello " +  hello.name );
		...
		if (requestMessage_tRESTRequest_1.containsKey("ERROR")) { // wrong request received
			...
			java.util.Map<String, Object> params_tRESTRequest_1 =
				(java.util.Map<String, Object>) requestMessage_tRESTRequest_1.get("PARAMS");
					if (matchedFlow_tRESTRequest_1.equals("hello")) {
						hello = new helloStruct();
								if (params_tRESTRequest_1.containsKey("PATH:name:id_String")) {
									
										
										hello.name = (String) params_tRESTRequest_1.get("PATH:name:id_String");
...
gen_Doc_out_tXMLMap_1.generateElements(rejectedDocInnerJoin_tXMLMap_1,hello,Var);

if(out_tmp.body == null){
out_tmp.body = new routines.system.Document();
out_tmp.body.setDocument(gen_Doc_out_tXMLMap_1.getDocument());
}
 ...
 */
	...
	currentComponent="tXMLMap_1";
				...
				if(execStat){
			  		runStat.updateStat(resourceMap,iterateId,2,0,"hello");
			  	}
 ...
 */
	...
	globalMap.put("tRESTRequest_1_NB_LINE", nb_line_tRESTRequest_1);
				...
				if(execStat){
					runStat.updateStatOnConnection(iterateId,2,0,"hello","out");
				}
 ...
 */
    ...
    public static void main(String[] args){
        final HelloWorldService HelloWorldServiceClass = new HelloWorldService();

        int exitCode = HelloWorldServiceClass.runJobInTOS(args);
    ...
    public int runJobInTOS(String[] args) {
        ...
        try {
            ...
            java.io.InputStream inContext = HelloWorldService.class.getClassLoader().getResourceAsStream("web_services_projects/helloworldservice_0_1/contexts/" + contextStr + ".properties");
            if (inContext == null) {
                inContext = HelloWorldService.class.getClassLoader().getResourceAsStream("config/contexts/" + contextStr + ".properties");
            }
            if (inContext != null) {
                try {
...
this.globalResumeTicket = true;//to run tPostJob
        ...
        if (false) {
            System.out.println((endUsedMemory - startUsedMemory) + " bytes memory increase when running : HelloWorldService");
        }
...
/************************************************************************************************
 *     78729 characters generated by Talend Open Studio for ESB 
 *     on the 3 avril 2025 à 14:27:30 WAT
 ************************************************************************************************/